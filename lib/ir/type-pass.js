...
class TypeAttachmentPass {
  ...
  processCreateChannel(instr) {
    // Channel element types require tracking through assignments
    // and variable symbol lookup - not implemented yet.
  }
  ...
  processChannelOp(instr) {
    // Channel type metadata propagation not implemented.
  }
