...
/**
 * @typedef {Object} BeginTry
 * @property {'BeginTry'} kind
 * @property {string} catchTarget
 * @property {string} finallyTarget
 */

/**
 * @typedef {Object} EndTry
 * @property {'EndTry'} kind
 */

/**
 * @typedef {Object} BeginCatch
 * @property {'BeginCatch'} kind
 * @property {Register} exceptionReg
 */

/**
 * @typedef {Object} EndCatch
 * @property {'EndCatch'} kind
 */

/**
 * @typedef {Object} BeginFinally
 * @property {'BeginFinally'} kind
 */

/**
 * @typedef {Object} EndFinally
 * @property {'EndFinally'} kind
 */

/**
 * @typedef {Object} Switch
 * @property {'Switch'} kind
 * @property {Operand} discriminant
 * @property {Array<{test: Operand, target: string}>} cases
 * @property {string} defaultTarget
 */

/**
 * @typedef {Object} MethodCall
 * @property {'MethodCall'} kind
 * @property {Register} dest
 * @property {Operand} object
