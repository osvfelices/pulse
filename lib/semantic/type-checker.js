 ...
 * Type Checker
 *
 * Optional, conservative type checker that validates explicit type annotations.
 * Only checks annotated code - no inference, no coercion, no advanced types.
 * If unsure about a case, it's ignored (fail-safe design).
 *
 * Stage 3.2.c
 */
